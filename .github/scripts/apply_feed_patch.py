...
if 'import android.text.SpannableString\n' not in text:
    text = text.replace(
        'import android.os.Bundle\n',
        'import android.os.Bundle\nimport android.text.SpannableString\nimport android.text.Spanned\nimport android.text.style.StyleSpan\n'
    )

field_marker = '    private var pendingPostPreview: ImageView? = null\n'
field_block = '''    private var pendingPostPreview: ImageView? = null
...
'''
if 'private data class FeedComment' not in text:
    text = text.replace(field_marker, field_block)
...
new_post_card = '''    private fun postCard(post: Post): View {
...
new_comments = '''    private fun commentsFor(post: Post): MutableList<FeedComment> =
